...
$(document).ready(function(){
	...
	// Adicionar Categoria Validation
    ...
    // Alerta elimina categoria
	$("#delCat").click(function(){
		if(confirm('Tem a certeza que quer eliminar esta categoria?')){
			return true;
		}
		return false;
	});

	// Alerta elimina produto
