...
class AdminController extends Controller
{
    public function login(Request $request){
    	...
    	if($request->isMethod('post')){
            ...
            if ($adminCount > 0) {
    			...
    			return redirect('/admin')->with('flash_message_error', 'Username ou Password Inválido.');
    		}
    	}
    ...
    public function dashboard(){
    	/*if(Session::has('adminSession')){
    		...
    		return redirect('/admin')->with('flash_message_error', 'Faça o login para aceder');
    	}*/
    ...
    public function logout(){
    	...
    	return redirect('/admin')->with('flash_message_success', 'Saiu da sessão com sucesso!');
    }
    ...
    public function addAdmin(Request $request){
        if ($request->isMethod('post')) {
            ...
            if($adminCount>0){
                return redirect()->back()->with('flash_message_error', 'Username already exists! Please choose another');
            } else {
                ...
                if (empty($data['categories_full_access'])) {
                    ...
                    if (empty($data['categories_full_access']==1)) {
    ...
    public function editAdmin(Request $request, $id){
        ...
        if ($request->isMethod('post')) {
            ...
            if (empty($data['status'])) {
                ...
                return redirect()->back()->with('flash_message_success', 'Sub Administrador atualizado com sucesso!');
            }
    ...
    public function myNotes(){
        return view('admin.admins.notes');
    }
}
