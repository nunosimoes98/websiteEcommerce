    ...
    <div class="row">
        <div class="col-xs-12">
    		<div class="invoice-title">
    			<h2 style="text-align: center; font-family: Trebuchet MS; font-style: italic;">Wolfwork Brand.</h2><h3 class="pull-right">Order # {{ $orderDetails->id }}</h3>
                <img src="{{ asset('images/frontend_images/logo-w.png') }}" alt=""   style="margin-bottom: 5px;">
    		</div>
    		<hr>
    		<div class="row">
    			<div class="col-xs-6">
